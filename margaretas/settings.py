...
MIDDLEWARE = [
    ...
    'margaretas.middleware.MensagensNotificacaoMiddleware',
    'margaretas.middleware.AppContextMiddleware',  
]

ROOT_URLCONF = 'margaretas.urls'
...
WSGI_APPLICATION = 'margaretas.wsgi.application'
